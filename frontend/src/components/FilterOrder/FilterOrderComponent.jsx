...
import { CheckbockContainer, DropdawnContainer } from '../../containers'
...
function FilterOrderComponent({
  ...
  return (
    <div className={style.container}>
      ...
      {search ? <span className={style.search}>{search}</span> : null}
      ...
      <form className={style.containerPrice} >
        ...
        />
        {getFieldState("startingPrice").isDirty || getFieldState("finalPrice").isDirty ?
